                ...
                <table class="table table-hover">
                    ...
                    <?php $i = 1; if($fetch_video){ foreach($fetch_video as $video_data){ ?>
                      <tr class="v-set">
                        ...
                        <td>
                            <iframe width="265" height="150" src="https://www.youtube.com/embed/<?php echo $video_data['v_url']; ?>" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </td>
