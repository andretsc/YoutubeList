...
<body>
    ...
    <div class="container-fluid">
        <div class="container">
            <ul class="nav justify-content-center bg-dark">
                <li class="nav-item">
                    <div class="nav-link heading">SNSギャラリー</div>
                    <div class="nav-link heading">SNSギャラリー</div>
                </li>
            </ul>
        </div>
                ...
                <form method="post" id="video-ins">
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-group col-sm-12 col-lg-2 mb-0">
                            <input type="submit" value="登録" class="btn btn-outline-dark" data-toggle="modal"
    ...
    <div class="modal fade" id="UpdateModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">ビデオを更新</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-dark" data-dismiss="modal" id="update_reset">閉じる</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="DeleteModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">ビデオを削除</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-dark" data-dismiss="modal" id="delete_reset">閉じる</button>
                    <button type="button" class="btn btn-outline-danger" id="video_delete">はい</button>
                </div>
            </div>
        </div>
    </div>
